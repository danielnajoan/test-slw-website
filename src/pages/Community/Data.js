import figureImage from "../../images/PublicFigure-1.png";
import testImage from "../../images/SLW Internal Team.png";
import chatBuble from "../../images/Temporary.png";
...
export const communityCoverObj = {
  ...
  buttonsData: [
    ...
    {
      id: 3,
      urlButton: "https://discord.gg/HTmgtMWp8T",
      buttonLabel: "Discord",
    },
    {
      id: 4,
      urlButton: "https://open.spotify.com/show/1v57eiSx5t85YRkORxKiEN",
      buttonLabel: "Spotify",
    },
  ],
};

export const instagramObj = {
  headline: "What’s on our Instagram?",
  subheadline: "Interactive Discussions",
  paragrah:
    "We are a community of youth learners and we love discussing about anxiety, insecurity, stress, school or career, and many more.",
  cardHeadline: "Click below to explore our past discussions.",
  discussionData: [
    {
      id: 1,
...
export const rantObje = {
  headline: "1:1 Rant Session with SLW’s Curhat Team",
  subheadline:
    "We’ve been listening to more than 5,000+ stories since we started in 2018.",
  paragrah:
    "We are a community of youth learners and we love discussing about anxiety, insecurity, stress, school or career, and many more.",
  imageUrl: chatBuble,
  imageName: "chatBuble",
...
export const contentObj = {
  ...
  subheadline: "Bringing fresh ideas through visual content.",
  paragraph:
    "Not only understanding mental health through films or book discussion, but also humane storytelling such as interviews and comic series.",
  buttonHeadline: "See more on our Instagram.",
  urlButton: "https://www.instagram.com/selflovewarrior.id/",
  ...
  activitiesData: [
    {
      ...
      imageName: "figureImage",
      cardDesc:
        "Take a break from this fast-paced life. Have fun conversations and make some new friends online!",
    },
    {
      id: 2,
      className: "#bootcamp",
      ...
      imageName: "figureImage",
      cardDesc:
        "Interactive learning experience with peers for topics they don’t teach you in school: Anxiety, Relationship, etc.",
    },
    {
      id: 3,
      className: "#school",
      ...
      imageName: "figureImage",
      cardDesc:
        "Collaborating with educational institutions and school councils.",
    },
    {
      id: 4,
      className: "#virtual",
      ...
      imageName: "figureImage",
      cardDesc:
        "Meet fellow warriors throughout your mental health journey with facilitators and professionals.",
    },
  ],
};
...
export const discordObj = {
  headline: "Hang out on our Discord Server!",
  subheadline: "SLW Discord Server is a platform for your every need.",
  urlButton: "https://discord.gg/HTmgtMWp8T",
  buttonLabel: "Join SLW Discord",
  imageUrl: discordOne,
  imageName: "Discord",
  title: "Having a bad day? Let it out here.",
  paragraph:
    "Our server has 4 venting channels curated for your specific needs. By joining our server, you can vent your frustrations, support each other, and even find friends based on your interests!",
};
...
export const spotifyObj = {
  headline: "Follow us on Spotify",
  urlButton: "https://open.spotify.com/show/1v57eiSx5t85YRkORxKiEN",
  ...
  spotifysData: [
    {
      ...
      urlIframe:
        "https://open.spotify.com/embed-podcast/show/1v57eiSx5t85YRkORxKiEN",
      iframeTitle: "Playlist - 1",
      paragraph:
        "A collection of 8 tracks to help you feel better when you don't have anyone to talk to, just like an imaginary friend on the phone. ",
    ...
    },
    {
      ...
      cardHeadline: "Audio Bytes: 1800-SLW",
      urlIframe:
        "https://open.spotify.com/embed-podcast/episode/3rbNil6JSmprVXz2J0xc0X",
      iframeTitle: "Playlist - 2",
      paragraph:
        "Fun and insightful discussions about mental health issues with fellow team members, public figures, and professionals.",
...
export const comInformationObj = {
  headline:
    "Let’s create an environment where it’s safe to talk about mental health.",
